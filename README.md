# 🧑‍🍳 Receita Prática de NotebookLM : </br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; *Modelos Estatísticos aplicados ao Mercado Financeiro*
...
* Imagens e gráficos conceituais
...
2. Selecione as preferências de áudio. Caso queira refinar o resultado, utilize a opção de direcionamento para guiar o foco da conversa entre os apresentadores:
...
2. Nas opções de formato do relatório, selecione a sugestão **"Study Guide"** para criar um guia estruturado instantaneamente:
   
   <img src="https://github.com/user-attachments/assets/bfb64f97-2725-480a-b235-950ec8ac7489" alt="Interface do Study Guide" width="150" />

3. Caso queira refinar os resultados, insira suas preferências para o Guia de Estudos antes de selecionar a opção "Gerar":
   
   <img src="https://github.com/user-attachments/assets/2c54322e-f686-4dd4-b157-704ee5d9225d" alt="Opções de customização do Guia de Estudos" width="400" />

---

## 🌶️ Temperando com Prompts (Chat Interativo)
...
```text
Atue como um examinador rigoroso. Gere 5 questões de múltipla escolha focadas em validação de modelos (overfitting, métricas de erro como RMSE e MAE) e forneça o gabarito comentado apenas no final.
```

### 3. Engenharia Reversa do Podcast
```text
Crie um roteiro de revisão baseado nos pontos mais importantes discutidos no Audio Overview gerado, preenchendo as lacunas conceituais que o podcast possa ter deixado de fora.
```
